...
bt_begin 01_notebook1 1 
  ...
  bt_ok_fexists ${DIRPATH_RESULTS}/notebook1.ipynb
...
bt_begin 02_notebook2 2
  ...
  bt_ok_fexists ${DIRPATH_RESULTS}/notebook2.ipynb
  ...
  bt_ok_fexists ${DIRPATH_RESULTS}/notebook2_plot.ipynb
...
bt_begin 03_notebook3 4
  ...
  bt_ok_dexists $DTS_DIR_CACHE_HOME/cache/data/example-data/zebrafish1/unified/MATs/mat-algorithm1_local_maxima/
  ...
  bt_ok_dexists $DTS_DIR_CACHE_HOME/cache/data/example-data/celegans1/unified/MATs/mat-algorithm1_local_maxima/
  ...
  bt_ok_dexists $DTS_DIR_CACHE_HOME/cache/data/example-data/medakashort1/unified/MATs/mat-algorithm1_local_maxima/
  ...
  bt_ok_dexists $DTS_DIR_CACHE_HOME/cache/data/example-data/stickleback1/unified/MATs/mat-algorithm1_local_maxima/
